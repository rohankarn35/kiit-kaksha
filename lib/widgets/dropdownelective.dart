...
import 'package:kiit_kaksha/sectiondetails/electivejson.dart';

Widget buildDropdownelective(
        ...
        dropdownSearchData: DropdownSearchData(
          ...
          searchMatchFn: (item, searchValue) {
            final cleanedItem = item.value!
                ...
                .toLowerCase();
            final cleanedJsonValue = json[item.value] != null
                ? json[item.value]!
                    .replaceAll(RegExp(r'[^A-Za-z0-9_]'), '')
                    .toLowerCase()
                : '';
